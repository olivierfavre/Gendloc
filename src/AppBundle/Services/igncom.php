...
// Fichier qui permet de récupérer les données de commune d'IGN
...
//<Request requestID="1" version="1.2" methodName="LocationUtilityService"><Place type="Departement">38</Place><Place type="Departement">73</Place><Place type="Departement">05</Place>	<Place type="Departement">26</Place><Place type="nature"></Place><Place type="nature"></Place>
...
echo '<table id="com-table"><caption>COMMUNE IGN</caption>
...
foreach ($res->Response->GeocodeResponse->GeocodeResponseList->GeocodedAddress as $place) {
	$coord = explode(";", $place->Address->Place[3]);
	$lat = ($coord[1]+$coord[3])/2;
	$lng = ($coord[0]+$coord[2])/2;
	echo '<tr class="">', '<td style="display:none;">',$lng,'</td><td class="com">',$place->Address->Place[0], '</td>', '<td>',$place->Address->PostalCode, '</td><td style="display:none;">',$lat,'</td></tr>';
	}
