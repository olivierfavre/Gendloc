...
/**
 * CAMA Appraisal
 * Return CAMA apprailsal information for a parcel.
 * 
...
try {
	$sql = "select id_pid as parcel_id, id_common_pid as common_parcel_id, txt_taxyear as tax_year, amt_netbldgvalue as building_value, 
		amt_Extrafeaturevalue as extra_features_value, amt_Landvalue as land_value, amt_totalvalue as total_value from dbo.tb_PubParcelInfo where ";
