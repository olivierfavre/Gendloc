...
try {
	$sql = "SELECT id_pid as parcel_id, dbo.ctb_PubLandUse.txt_LandUse_fullDesc as land_use, dbo.tb_Publand.cnt_landunits as units, dbo.tb_publand.txt_neigh_desc as neighborhood 
