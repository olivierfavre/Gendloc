...
/**
 * CAMA Situs Address
 * Provides a link to the house photos in the CAMA database.
 * Return the situs addresses for a parcel id.
 * 
...
try {
	$sql = "select id_pid as parcel_id, id_common_pid as common_parcel_id, num_HouseNo as house_number, 
	txt_stdir as prefix, rtrim(txt_stname) as street_name, txt_STTYPE as road_type, txt_STSUFFIX as suffix, 
	ISNULL(num_HouseUnit,'') as unit, CDE_MUNIC_DESC AS city from dbo.tb_PUBLOCATION 
	where ";
